...
Para agilizar o cálculo de quanto cada cliente deve pagar ele desenvolveu uma tabela que contém o número de itens que 
...
print('*'*30)
print(f"{'Quantidade':<10}{'Preço':>10}")
print("-"*30)

for i in range (1,51):
    print(f"{i:<10}{(i*1.99):>10.2f}")
